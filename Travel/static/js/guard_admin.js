...
// Сравнение паролей
function isConfirm(csrfmiddlewaretoken, password1, password2, pass22, submit){
  // Пароль 1
  PASS1 = document.forms[csrfmiddlewaretoken].password1.value;
  // Длина пароля
  PASS1count = document.forms[csrfmiddlewaretoken].password1.value.length;
  // Пароль 2
  PASS2 = document.forms[csrfmiddlewaretoken].password2.value;
  // Индикатор совпадения паролей
  PASS22 = document.getElementById(pass22);
  // Кнопка отправки формы
  SUBMIT = document.forms[csrfmiddlewaretoken].submit;
